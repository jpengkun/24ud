...
public class Utils {
    ...
    public static final String dfxj1009 = "DFXJ1009"; // 纸票开具接口
    public static final String dfxj1010 = "DFXJ1010"; // 查询当前未开票号接口
    public static final String dfxj1011 = "DFXJ1011"; // 红字发票申请与查询接口
    public static final String dfxj1012 = "DFXJ1012"; // 纸票作废接口
