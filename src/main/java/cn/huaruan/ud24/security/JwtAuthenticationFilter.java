...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(SecurityUserService securityUserService, JwtUtils jwtUtils, CustomConfig customConfig) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (StrUtil.isNotBlank(jwt)) {
            try {
                ...
                ResponseUtil.renderJson(response, new ResultMessage().exception(e));
            }
        } else {
            ResponseUtil.renderJson(response, new ResultMessage(ResultStatus.UNAUTHORIZED));
        }
